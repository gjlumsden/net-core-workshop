// <auto-generated />
using System;
using EntityFrameworkWebApp.Entities;
...
{
    [DbContext(typeof(AdvWorksContext))]
    [Migration("20190610110058_ReallyBadName")]
    partial class ReallyBadName
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EntityFrameworkWebApp.Entities.Address", b =>
                {
            ...
            modelBuilder.Entity("EntityFrameworkWebApp.Entities.BuildVersion", b =>
                {
            ...
            modelBuilder.Entity("EntityFrameworkWebApp.Entities.Customer", b =>
                {
            ...
            modelBuilder.Entity("EntityFrameworkWebApp.Entities.CustomerAddress", b =>
                {
                    b.Property<int>("CustomerId")
                        .HasColumnName("CustomerID");
            ...
            modelBuilder.Entity("EntityFrameworkWebApp.Entities.ErrorLog", b =>
                {
            ...
            modelBuilder.Entity("EntityFrameworkWebApp.Entities.Product", b =>
                {
            ...
            modelBuilder.Entity("EntityFrameworkWebApp.Entities.ProductCategory", b =>
                {
                    b.Property<int>("ProductCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ProductCategoryID")
            ...
            modelBuilder.Entity("EntityFrameworkWebApp.Entities.ProductDescription", b =>
                {
            ...
            modelBuilder.Entity("EntityFrameworkWebApp.Entities.ProductModel", b =>
                {
                    b.Property<int>("ProductModelId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ProductModelID")
            ...
            modelBuilder.Entity("EntityFrameworkWebApp.Entities.ProductModelProductDescription", b =>
                {
                    b.Property<int>("ProductModelId")
                        .HasColumnName("ProductModelID");
            ...
            modelBuilder.Entity("EntityFrameworkWebApp.Entities.SalesOrderDetail", b =>
                {
            ...
            modelBuilder.Entity("EntityFrameworkWebApp.Entities.SalesOrderHeader", b =>
                {
                    b.Property<int>("SalesOrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("SalesOrderID")
            ...
            modelBuilder.Entity("EntityFrameworkWebApp.Entities.CustomerAddress", b =>
                {
                    b.HasOne("EntityFrameworkWebApp.Entities.Address", "Address")
                        .WithMany("CustomerAddress")
                        .HasForeignKey("AddressId");

                    b.HasOne("EntityFrameworkWebApp.Entities.Customer", "Customer")
                        .WithMany("CustomerAddress")
            ...
            modelBuilder.Entity("EntityFrameworkWebApp.Entities.Product", b =>
                {
                    b.HasOne("EntityFrameworkWebApp.Entities.ProductCategory", "ProductCategory")
                        .WithMany("Product")
                        .HasForeignKey("ProductCategoryId");

                    b.HasOne("EntityFrameworkWebApp.Entities.ProductModel", "ProductModel")
                        .WithMany("Product")
            ...
            modelBuilder.Entity("EntityFrameworkWebApp.Entities.ProductCategory", b =>
                {
                    b.HasOne("EntityFrameworkWebApp.Entities.ProductCategory", "ParentProductCategory")
            ...
            modelBuilder.Entity("EntityFrameworkWebApp.Entities.ProductModelProductDescription", b =>
                {
                    b.HasOne("EntityFrameworkWebApp.Entities.ProductDescription", "ProductDescription")
            ...
            modelBuilder.Entity("EntityFrameworkWebApp.Entities.SalesOrderDetail", b =>
                {
                    b.HasOne("EntityFrameworkWebApp.Entities.Product", "Product")
                        .WithMany("SalesOrderDetail")
                        .HasForeignKey("ProductId");

                    b.HasOne("EntityFrameworkWebApp.Entities.SalesOrderHeader", "SalesOrder")
                        .WithMany("SalesOrderDetail")
            ...
            modelBuilder.Entity("EntityFrameworkWebApp.Entities.SalesOrderHeader", b =>
                {
                    b.HasOne("EntityFrameworkWebApp.Entities.Address", "BillToAddress")
                    ...
                    b.HasOne("EntityFrameworkWebApp.Entities.Address", "ShipToAddress")
